...
procedure TForm4.SpecGridSelectCell(Sender: TObject; ACol, ARow: Integer;
  var CanSelect: Boolean);
...
var
        I: Integer;
begin
        SpecGrid.ColCount := I_FN_NOM1 + 13;
        SpecGrid.Cells[0, 0] := '№';
        ...
        SpecGrid.Cells[I_FN_NOM1+9, 0] := 'IdГП';
        SpecGrid.Cells[I_FN_NOM1 + 10, 0] := 'Н\ч Гибка';
        SpecGrid.Cells[I_FN_NOM1 + 11, 0] := 'Н\ч Резка';
        SpecGrid.Cells[I_FN_NOM1 + 12, 0] := 'Дата';
        ...
        SpecGrid.Cells[I_FN_NOM1+8, 1] := 'False';
        SpecGrid.Cells[I_FN_NOM1+9, 1] := 'False';
end;
...
begin
 if not Form1.mkQueryInsert(Form1.ADOQuery1, 'Insert Into %s '
                                        ...
                                        '[Углоруб],[Угол], [Гибка], [Прокатка], [Пила],[Сварка],IdГП,Изделие,Заказ,Дата) ' +
                                        ...
                                        #39 + IntToStr(1) + #39, #39 + '1' +
                                               ...
                                               #39 + SpecGrid.Cells[I_FN_NOM1+4, 1] + #39, #39 + SpecGrid.Cells[I_FN_NOM1+5, 1] + #39, #39 + SpecGrid.Cells[I_FN_NOM1+6, 1]
                                                        + #39, #39 + SpecGrid.Cells[I_FN_NOM1+7, 1] + #39, #39 +
                                                        SpecGrid.Cells[I_FN_NOM1+8, 1] + #39, #39 +
                                                        SpecGrid.Cells[I_FN_NOM1+9, 1] + #39, #39 + SpecGrid.Cells[I_FN_NOM1+10, 1] + #39, #39
                                                        + 'Naim' + #39, #39 + SpecGrid.Cells[I_FN_ZAK1, 1] + #39,
                                                        #39 + Form1.ConvertDat1(SpecGrid.Cells[I_FN_NOM1+13, 1]) + #39])
                                                        then
                                        exit;
 FSpec.Button1.Click;
 Close;
