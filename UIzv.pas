...
procedure TFizv.btn1Click(Sender: TObject);
...
procedure TFizv.btn4Click(Sender: TObject);
var I:Integer;
begin
...
procedure TFizv.btn5Click(Sender: TObject);
...
procedure TFizv.btn6Click(Sender: TObject);
begin
  Close;
end;

procedure TFizv.btn7Click(Sender: TObject);
...
procedure TFizv.btn8Click(Sender: TObject);
var KL,T,S:string;
I:Integer;
begin
...
procedure TFizv.btndt1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var Res1,Res2,Res3,I,l,C:Integer;
S,S1,T,KL:string;
begin
...
procedure TFizv.ComboBox1Select(Sender: TObject);
var KL,T:string;
I:Integer;
begin
    //==============================
...
procedure TFizv.ComboBox2Select(Sender: TObject);
begin
  btn8.Click;
end;

procedure TFizv.FormShow(Sender: TObject);
var I:Integer;
begin
      if not Form1.mkQuerySelect1(Form1.ADOQuery2,
      'Select * from %s Order by ID' ,
...
procedure TFizv.N1Click(Sender: TObject);
begin
  FNewTip.Show;
end;

procedure TFizv.N2Click(Sender: TObject);
begin
...
procedure TFizv.N3Click(Sender: TObject);
begin
    if not Form1.mkQueryUpdate(Form1.ADOQuery1,
...
procedure TFizv.N4Click(Sender: TObject);
begin
...
procedure TFizv.N5Click(Sender: TObject);
begin
